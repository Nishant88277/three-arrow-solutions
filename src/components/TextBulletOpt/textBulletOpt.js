...
const TextBulletopt = () => {
  return (
    <div className="container mx-auto mt-5 ml-0 pl-0">
          ...
          return (
            <List
              className="relative mb-5 cursor-pointer hover:font-bold duration-100 transition-all px-16 before:ml-8 before:absolute before:-left-4 before:bottom-1
                    before:border-2 before:border-solid before:rounded-full before:contents:(' ') before:w-6
                    before:h-6 Git_text xl:text-4xl dark:text-[#fff] text-black leading-normal mt-3 "
              key={index}
            >
              {item.text}
            </List>
