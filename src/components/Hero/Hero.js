    ...
    <div className="container mx-auto">
      <div className="flex  xl:justify-between flex-wrap md:mt-20 xl:mb-10  xl:p-0 px-5">
        <div className="xl:w-6/12">
          <HeadingSection className="font-extrabold xl:text-8xl xl:leading-tight tracking-tighter py-4 max-w-[614px]">
          ...
          <div className=" flex flex-row xl:mt-32 mt-16 ">
            <input
              className="p-8 xl:w-9/12 md:w-[40%] w-[70%] max-w-[500px] xl:h-28  rounded-bl-lg rounded-tl-lg dark:bg-[#052d56] bg-[#DDDDDD] text-[#052d56] dark:text-[#ffffff] font-semibold focus:outline-none"
              type="text"
              placeholder="Your Email Address"
            />
            <Button className="xl:w-3/12 md:w-[20%] w-[30%] max-w-[200px] text-xl md:text-2xl xl:text-4xl  text-white rounded-br-lg rounded-tr-lg">
              Get Started
            </Button>
          </div>
        </div>
