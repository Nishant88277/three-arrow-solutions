...
const TwoSection = ({space}) => {
  return (
    <div
      className={`flex justify-center xl:flex-row flex-col text-white ${space}`}
    >
      <div className="xl:w-3/6 bg-[#313a5a] xl:px-28 px-10 py-20">
        ...
        <button
          className="xl:py-5 xl:px-10 py-4 px-8 font-black text-2xl rounded-full
      ...
      <SecondSec className="xl:w-3/6 xl:px-28 px-10 py-20">
        ...
        duration-700 text-2xl rounded-full text-black hover:text-white
