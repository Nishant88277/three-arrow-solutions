...
const Career = ({space}) => {
    return (
      <CareerBox
        className={`flex md:flex-row flex-col py-10 xl:px-10 px-10 justify-between rounded-xl xl:items-center Carrer_div ${space}`}
      >
        ...
        <div className="xl:w-[20%] xl:mt-0 mt-3 dark:text-black text-white gap-5 leading-loose">
          <div className="flex justify-between">
            ...
            <div className="w-[70%] font-medium">
              <a href="mailto:contact@threearrow.in">contact@threearrow.in</a>
            </div>
          </div>
          <div className="flex justify-between ">
            ...
            <div className="w-[70%] font-medium">+91 1234567890</div>
          </div>
        </div>
        <div className="md:w-1/5 md:mt-0 mt-3 flex xl:justify-end xl:mt-0 mt-12 items-center">
          <div className="bg-white flex justify-around rounded-full p-2 w-80 cursor-pointer delay-75 duration-700 transition-all text-black hover:bg-black hover:text-white dark:bg-black dark:text-white dark:hover:bg-white dark:hover:text-black">
